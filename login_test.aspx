<%@ Page Language="VB" AutoEventWireup="false" CodeFile="login_test.aspx.vb" Inherits="Pages_login_test" %>
    ...
    <form id="form1" runat="server">
        <asp:UpdatePanel runat="server">
            <ContentTemplate runat="server">
                ...
                <asp:HiddenField runat="server" ID="hdnMail" />
                        ...
                        <div class="form-content">
                            <div class="login-form" id="DivLogin" runat="server">
                                ...
                                <div class="input-boxes">
                                    <div class="input-box">
                                        ...
                                        <asp:TextBox runat="server" type="text" placeholder="Enter your User Name" ID="txtLoginEmail"/>
                                    </div>
                                    <div class="input-box">
                                        <i class="fas fa-lock"></i>
                                        <asp:TextBox runat="server" type="password" placeholder="Enter your password" ID="txtLoginPassword" />
                                    </div>
                                    <div class="input-box" runat="server" id="divLoginOtp" Visible="false">
                                        <i class="fas fa-code"></i>
                                        <asp:TextBox runat="server" placeholder="Enter your code" ID="txtLoginOtp" />
                                    </div>
                                    ...
                                    <div class="text sign-up-text">
                                        ...
                                        <asp:Button runat="server" Text="Fogot Passowrd" ID="btnForgotPasswordToggle" CssClass="button_change" />
                                    </div>
                                </div>
                            </div>
                            <div class="signup-form" id="DivSignIn" runat="server" visible="false">
                                ...
                                <div class="input-boxes">
                                    ...
                                    <div class="input-box" id="txtpass" runat="server" style="height: auto">
                                        <p>
